...
del \f "%thisdir%\%tempmanifest%"
del \f "%thisdir%\CreateShortcut.vbs"
del \f "%thisdir%\%tempjarname%"
...
IF EXIST "%thisdir%\%tempjarname%" del \f "%runelitedir%\%finaljarname%"
...
echo  Backing up old shortcuts to runelite
...
mkdir backup
mkdir "%startmenu%\RuneLite"
IF NOT EXIST "%startmenu%\RuneLite\RuneLiteBackup.lnk" move "%startmenu%\RuneLite.lnk" "%startmenu%\RuneLite\RuneLiteBackup.lnk"
